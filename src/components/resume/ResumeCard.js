...
const ResumeCard = ({title,subTitle,result,des}) => {
  return (
    <div className='w-full h-1/3 group flex'>
     ...
     rounded-lg p-4 lgl:px-10 flex flex-col justify-center gap-6 lgl:gap-10 shadow-shadow0ne'>
     <div className='flex flex-col lgl:flex-row justify-between gap-4 lgl:gap-0
    lgl:items-center'>
      <div>
      <h3 className='text-xl md:text-2x1 font-semibold group-hover:text-white duration-300'>
      {title}
      </h3>
