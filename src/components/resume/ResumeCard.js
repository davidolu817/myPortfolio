...
const ResumeCard = ({title,subTitle,result,des}) => {
  return (
    <div className='w-full h-1/3 group flex'>
     ...
     <div className='w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration
     rounded-lg px-10 flex flex-col justify-center gap-10 shadow-shadow0ne'>
     <div className='flex justify-between items-center'>
      <div>
      <h3 className='text-2x1 font-semibold group-hover:text-white duration-300'>
      {title}
      </h3>
